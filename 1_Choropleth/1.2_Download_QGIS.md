...
**Tutorial 1.2** demonstrates how to download the correct software, QGIS, for this project (*Figure 1.2-1)*. You only need to do this step if you wish to install QGIS on your own machine. QGIS works on Mac or PC. If you plan to work in the computer labs on campus - it is already installed for you.
