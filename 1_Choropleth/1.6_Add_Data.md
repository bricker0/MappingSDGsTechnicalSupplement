...
Click the three dots and name your file *UN_wom_par_eiv.shp* or something that reflects your data. Confirm *Add saved file to the map* is selected and click *OK*. 
