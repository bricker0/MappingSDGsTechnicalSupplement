...
Fill in the *Expression*. On the right panel, expand *Fields and Values* and double click on *Percent* to insert it into the expression. Or type the name of the attribute you are trying to select. Then type *>= 50*and click *Select Features*. Click *Close*. Here you may want to change the value based on what you are trying to highlight in your own dataset.
