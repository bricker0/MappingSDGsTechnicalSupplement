...
If you are using the **Geodatabase**, that you downloaded from the UN Website follow these instructions carefully:
...
Since you are making a choropleth map, which relies on area, you want to reduce the distortion of area. However, this means you will distort shape. The Eckert IV projection, a common ***equal-area projection*** for world maps, is a good choice for choropleth maps, and it is what the UN file is projected in.
...
> ***Interupped Goode Homolosine projection***
> For islands - it is advised to use the Interupped Goode Homolosine projection - you can read more about it here <a href> https://github.com/bricker0/SIDS </a> but this is very advanced and doesn't work well in QGIS. 
>
**Setting the Scale**
